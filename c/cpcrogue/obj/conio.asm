...
___str_0:
	.ascii "%d"
	.db 0x00
;src/conio.c:51: void BlackScreen()
;	---------------------------------
; Function BlackScreen
; ---------------------------------
_BlackScreen::
;src/conio.c:53: ink (0, INK_BG,INK_BG);
	ld	hl, #0x0000
	push	hl
	xor	a, a
	push	af
	inc	sp
	call	_ink
;src/conio.c:54: ink (1, INK_BG,INK_BG);
	inc	sp
	ld	hl,#0x0000
	ex	(sp),hl
	ld	a, #0x01
	...
	inc	sp
	call	_ink
;src/conio.c:55: ink (2, INK_BG,INK_BG);
	inc	sp
	ld	hl,#0x0000
	ex	(sp),hl
	ld	a, #0x02
	...
	inc	sp
	call	_ink
;src/conio.c:56: ink (3, INK_BG,INK_BG);
	inc	sp
	ld	hl,#0x0000
	ex	(sp),hl
	ld	a, #0x03
...
;src/conio.h:10: putchar (color1); putchar (color1);
	...
	call	_putchar
	pop	af
;src/conio.c:58: border (0); paper (0);
	xor	a, a
	push	af
	inc	sp
	call	_paper
